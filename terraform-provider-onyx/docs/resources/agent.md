...
page_title: "onyx_agent Resource - terraform-provider-onyx"
subcategory: ""
description: |-
...
- `builtin_agent` (Boolean) Whether Onyx ships the agent as a built-in. Built-in agents are configured in the deployment, not through the API.
